...
global_image1_data = None
global_image2_data = None
def set_images_data(image1_data, image2_data):
    global global_image1_data
    global global_image2_data
    global_image1_data = image1_data
    global_image2_data = image2_data

def compare_translated_images(scale_rotate_translate):
    return scaled_rotated_translated_image_rmse3(global_image1_data, global_image2_data, scale_rotate_translate[0:2], scale_rotate_translate[2], scale_rotate_translate[3:])

def compare():
    # crop
    image2_data = 255 - global_image2_data
    ...
    image1 = Image.fromarray(global_image1_data)
    ...
    bounds = [
        (0.9*widths_ratio, 1.1*widths_ratio),  # x scaling
        (0.9*heights_ratio, 1.1*heights_ratio),  # y scaling
        (-pi/9, pi/9),  # rotation
        (-image2_data.shape[1]//2, image1_data.shape[1]//2),  # x translation
        (-image2_data.shape[0]//2, image1_data.shape[0]//2)  # y translation
    ]
...
set_images_data(np.array(image1), np.array(image2))
compare()
