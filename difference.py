...
image1_filename = './google-fonts/ofl/images/FiraSans-Regular/Q.png'
image2_filename = './google-fonts/ofl/images/FiraSans-Regular/O.png'
...
def pad(image_data, dimensions, translate=(0, 0)):
...
def translated_image_rmse(image1_data, image2_data, translate):
    if translate[0] >= 0 and translate[1] >= 0:
        ...
        padded_image1_data = pad(image1_data, (total_height, total_width))
        padded_image2_data = pad(image2_data, (total_height, total_width), translate)
    ...
    if translate[0] >= 0 and translate[1] < 0:
        ...
        padded_image1_data = pad(image1_data, (total_height, total_width), (0, -translate[1]))
        padded_image2_data = pad(image2_data, (total_height, total_width), (translate[0], 0))
        # show_diff(padded_image1_data, padded_image2_data)
        return image_rmse(padded_image1_data, padded_image2_data)
